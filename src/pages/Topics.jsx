    ...
    <section className="space-y-10">
      <header className="space-y-3">
        ...
        <p className="text-sm text-slate-600 transition-colors dark:text-dracula-muted md:max-w-2xl">
          Wähle einen Bereich und entdecke kuratierte DevGuides. Jeder Themenblock fasst die wichtigsten Use-Cases und
          Patterns zusammen – perfekt für fokussiertes Lernen.
        </p>
      </header>
