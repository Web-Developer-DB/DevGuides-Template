...
- Neuer Guide: „Kostenlose Sicherheits-Tools fuer Linux Mint 22.3“.
- Zusätzliche Tests fuer Hashtag-Filter und Query-Parameter.
...
### Changed
- Projektname auf „DevGuides Template“ umgestellt (UI, Titel, Metadaten).
- Navigation und Footer auf Tutorial-Fokus gestrafft, Hashtag-Navigation ergänzt.
- Startseite neu ausgerichtet: Tutorials, Hashtags und Workflow im Fokus.
